...
fit.pc <- principal(numericAlgaeData, nfactors=4, rotate="varimax")
fit.pc
...
#Now we will visualize according to factor recommendation by taking into the account factors=3
fit.pc_2 <- principal(numericAlgaeData, nfactors=3, rotate="varimax")
fit.pc_2
fa.plot(fit.pc_2)
fa.diagram(fit.pc_2)
```
